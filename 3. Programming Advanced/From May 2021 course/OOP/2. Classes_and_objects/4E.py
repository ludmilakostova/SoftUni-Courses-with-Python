class PizzaDelivery:
    ...
    def remove_ingredient(self, ingredient: str, quantity: int, price_per_ingredient: float) -> object:
        if self.ordered:
            return f'Pizza {self.name} already prepared, and we can\'t make any changes!'
    ...
    def make_order(self):
        ...
        result += ", ".join([f'{ingr}: {quantity}' for ingr, quantity in self.ingredients.items()])

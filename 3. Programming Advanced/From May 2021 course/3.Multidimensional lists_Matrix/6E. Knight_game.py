...
def knights_are_attacking_each_other(matrix):
    knights_positions = find_all_knights(matrix)
...
def calculate_aggression(matrix, knight_position):
    aggression_scores = {}
    for pos in knight_position:
        ...
        attacked_count = 0
        for attacked_row, attacked_col in position_to_check:
...
def main():
    ...
    while knights_are_attacking_each_other(matrix) is True:
        ...
        aggression_scores = calculate_aggression(matrix, knight_position)
